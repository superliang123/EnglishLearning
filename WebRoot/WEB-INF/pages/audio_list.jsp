...
<html>
    ...
    <table class="table table-hover">
    	...
    	<tr>
    		...
    		<td>
	    		...
	    		&#12288<a href="audio/download?path=${record.path}">下载</a>
  ...
  <script type="text/javascript">
  		...
  		function play(id){
			...
			$.post("audio/goPlay",{"id":id},function(data){
  		...
  		function del(id){
			...
			$.post("audio/del",{"id":id},function(data){
		...
		function list(currPage){
				...
				$.post("audio/list",{"currPage":currPage},function(data){
		...
		function sou(currPage){
			...
			$.post("audio/list",{"currPage":currPage,"soukey":$("#soukey").val()},function(data){
		...
		function sub(){
			if($("input[type='checkbox']:checked").length==0){
				...
				$.post("audio/delMore",$('#form1').serialize(),function(data){
